<template>
  ...
  <div class="row justify-start clickable-card" v-else>
    ...
    >
      <q-card-section class="row justify-start items-start">
        <div class="col-12 col-md-3">II. PROGRAM COURSE EVALUATION</div>
    ...
    <div class="row justify-center clickable-card">
      <template v-for="(studEval, i) in subjectlist" :key="i">
        <q-card
          ...
          v-if="studEval.evalCode === 'PCEC2023'"
        >
    ...
    >
      <q-card-section class="row justify-start items-start">
        <div class="col-12 col-md-4">III. FACULTY PERFORMANCE EVALUATION</div>
      </q-card-section>
    </q-card>
    <div class="row justify-center clickable-card">
      <template v-for="(studEval, i) in subjectlist" :key="i">
        <q-card
          ...
          v-if="studEval.evalCode === 'TBEC2023'"
          style="min-width: 400px"
        >
          <q-card-section class="text-center">
            <!-- <q-avatar
