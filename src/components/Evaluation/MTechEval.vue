<template>
  ...
  <div class="row justify-start clickable-card" v-else>
    <q-card
    ...
    <div class="row justify-start clickable-card">
      <SSEval :subject="studServiceEval" />
    </div>
    <q-card class="col-12 text-h6 bg-primary text-white q-mt-xl q-mb-lg">
      <q-card-section
        class="row justify-start q-ml-md"
        v-if="subjectlist.length !== 0"
      >
        <div class="col-12 col-md">II. CURRICULUM EVALUATION</div>
    ...
    <div class="row justify-center clickable-card">
      <template v-for="(studEval, i) in subjectlist" :key="i">
        ...
        <q-card
          ...
          v-if="
            studEval.facultyId == 0 ||
            studEval.facultyId == '' ||
            studEval.facultyId == null
          "
    ...
    <!-- <div class="row justify-center clickable-card"> -->
    <q-card class="col-12 text-h6 bg-primary text-white q-mt-xl q-mb-lg">
      <q-card-section v-if="subjectlist.length !== 0">
        III. FACULTY PERFORMANCE EVALUATION
      </q-card-section>
    </q-card>
    ...
    <template v-for="(studEval, i) in subjectlist" :key="i">
      ...
      >
        <q-card-section class="text-center">
          ...
          <br /> -->
          <div
            :class="studEval.dateCompleted === null ? 'text-red' : 'text-green'"
          >
            {{
              studEval.dateCompleted === null
                ? "NOT YET COMPLETED"
                      ...
                      <q-list>
                        <q-item>
                          ...
                          <q-item-section side top class="col">
                            <!---FOR MED TECH CURRICULUM EVAL (ratings 1-5)-->
                            <div
                              class="q-gutter-sm"
                              v-if="
                            ...
                            <!---FOR MED TECH FACULTY EVAL (ratings 1-4)-->
                            <div
                              class="q-gutter-sm"
                              v-if="
                                content.evaluationType !==
...
export default defineComponent({
  ...
  methods: {
    ...
    isCardDisabled(studEval) {
      ...
      console.log("HERE AT currentDate", currentDate);
      console.log("HERE AT", dateTo);
