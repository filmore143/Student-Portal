          ...
          <div>
            ...
            >
              <q-card flat>
                ...
                >
                  COLLEGIATE EDUCATIONAL BACKGROUND
                </q-card-section>
              </q-card>
              ...
              <div class="row justify-evenly q-gutter-md">
                ...
                <div class="col-12 col-md">
                  ...
                  <q-input
                    ...
                    debounce="500"
                    filled
                    placeholder="Ex. BS Medical Technology"
...
export default {
  ...
  methods: {
    ...
    handleProvincesChange(province) {
      console.log("QWERTYUIOP", province);
    ...
    async checkExistingClearance() {
      ...
      const validateClearanceIfExist = result.result;
      if (
        LocalStorage.getItem("access_token") &&
        validateClearanceIfExist == 0
      ) {
